<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPage/MP_Central.master" AutoEventWireup="true" CodeFile="Lista_Libros.aspx.cs" Inherits="NavPrivada_Lista_Peliculas" %>
            ...
            <div class="uk-container">
                ...
                <ul class="uk-switcher uk-margin">
                    ...
                    <li>
                        <div class="uk-card uk-card-default">
                            <div class="uk-card-body uk-overflow-auto">
                                <asp:GridView ID="GrillaLibrosNA" DataKeyNames="id_Libro" CssClass="uk-table uk-table-divider uk-table-small" AutoGenerateColumns="False"
                                    BorderStyle="None" GridLines="None" runat="server" OnRowCommand="GrillaLibrosNA_RowCommand">
                                    <Columns>
                                        <asp:TemplateField HeaderText="ID Manga" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_id" runat="server" Text='<%# Eval("id_Libro") %>'></asp:Label>
